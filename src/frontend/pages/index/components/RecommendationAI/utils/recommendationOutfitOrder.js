/**
 * Layer order for chained virtual try-on (inner → outer).
 * Lower = applied first. Matches RecommendationCard category semantics.
 */
...
/** English category chip for UI (aligned with RecommendationCard) */
